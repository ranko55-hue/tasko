-- 023: תיקון שמות תפקידים בטריגר tasks_guard_manager_edit.
--
-- מיגרציה 019 דרסה את הפונקציה עם שמות התפקידים הישנים
-- ('project_manager','work_manager') במקום ('admin','manager').
-- הטיפוס member_role כבר לא מכיל את הערכים הישנים (הוסר ב-016),
-- ולכן כל UPDATE על tasks נכשל עם:
--   invalid input value for enum member_role: "project_manager"
