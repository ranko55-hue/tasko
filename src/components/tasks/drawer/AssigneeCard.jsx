...
export default function AssigneeCard({ task, assigneeName }) {
  ...
  return (
    <div className="mx-4 mb-4 flex items-center gap-3 rounded-xl border border-line bg-white p-3 sm:mx-5">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex items-center gap-1.5 text-xs text-slate-500">
          {running && <span className="h-1.5 w-1.5 rounded-full bg-statusGreen animate-softPulse" />}
      ...
      {running && (
        <span
          className="shrink-0 rounded-lg border border-statusGreen/40 bg-statusGreen/10 px-2.5 py-1 text-sm font-bold text-green-700"
          style={NUM}
        >
