...
export const he = {
  ...
  reports: {
    ...
    to: 'עד תאריך',
    scopeAll: 'כל העובדים',
    scopeOne: 'עובד ספציפי',
    pickEmployee: 'בחירת עובד',
    pickEmployeePh: 'בחר עובד…',
    exportCsv: 'ייצוא CSV',
    print: 'הדפסה',
    correct: 'הוסף / תקן דיווח',
    attendance: {
      title: 'דוח נוכחות',
      hint: 'שעות עבודה, ימי חופשה ומחלה לכל העובדים בטווח תאריכים',
    },
  },
  ...
  attendance: {
    ...
    // מסך דיווח שעות + רכיב הדיווח
    pageTitle: 'דיווח שעות',
    pageSubtitle: 'דיווח נוכחות ושעות — ציר נפרד מזמן המשימות',
    myReports: 'הדיווחים שלי',
    allMyReports: 'כל הדיווחים שלי ←',
    scope: { full: 'יום מלא', hours: 'שעות מסוימות', range: 'טווח תאריכים' },
    date: 'תאריך',
    fromHour: 'משעה',
    toHour: 'עד שעה',
    fromDate: 'מתאריך',
    toDate: 'עד תאריך',
    noteLabel: 'הערה',
    attachNote: 'צירוף אישור',
    confirm: 'אישור דיווח',
    saved: 'הדיווח נשמר',
    timeOrder: 'שעת הסיום חייבת להיות אחרי ההתחלה',
    rangeOrder: 'תאריך הסיום חייב להיות אחרי ההתחלה',
    hoursUnit: 'ש׳',
    daysUnit: 'ימים',
    fullDay: 'יום מלא',
    byManager: 'דווח ע״י מנהל',
    typeCol: 'סוג',
    hoursCol: 'שעות',
  },

  // חיוב, חבילות וסליקה (Cardcom)
  billing: {
    status: {
      trialing: 'ניסיון',
      active: 'פעיל',
    ...
    vipTitle: 'חשבון פטור',
    vipNote: 'הארגון פטור מחיוב — גישה מלאה, ללא הגבלת זמן.',
    setVip: 'סמן פטור',
    unsetVip: 'בטל פטור',
    currentPlan: 'חבילה נוכחית',
    trialEnds: 'תקופת הניסיון מסתיימת ב-{date}',
    trialEndsShort: 'ניסיון עד {date}',
    nextCharge: 'החיוב הבא: {amount} ₪ ב-{date}',
    accessUntil: 'הגישה נשמרת עד {date}',
    howCalc: 'איך מחושב',
    calcLine: '199 בסיס + {extra} עובדים × 49 = {amount} ₪ לחודש',
    vatNote: 'המחירים בתוספת מע״מ ככל שיחול.',
    startNow: 'התחלת מנוי — {amount} ₪/חודש',
    paymentMethod: 'אמצעי תשלום',
    updateCard: 'עדכון כרטיס',
    history: 'היסטוריית חיובים',
    noInvoices: 'אין עדיין חיובים.',
    viewInvoice: 'חשבונית',
    invoiceNo: 'חשבונית {n}',
    cancel: 'ביטול מנוי',
    cancelConfirm: 'לבטל את המנוי? הגישה תישמר עד סוף התקופה, ואז המערכת תינעל. הנתונים יישמרו 30 יום.',
    resume: 'חידוש מנוי',
    actionError: 'הפעולה נכשלה. נסו שוב.',
    seatsUnit: 'מושבים',
    lockTitle: 'המנוי אינו פעיל',
    lockExpired: 'המנוי פג תוקף. חדשו כדי להמשיך לעבוד.',
    lockCanceled: 'המנוי בוטל. חדשו כדי להמשיך לעבוד.',
    lockTrialEnded: 'תקופת הניסיון הסתיימה. הזינו אמצעי תשלום כדי להמשיך.',
    retention: 'הנתונים שלכם יישמרו עד {date}.',
    payNow: 'לתשלום — {amount} ₪/חודש',
    contactAdmin: 'פנו למנהל המערכת של הארגון להסדרת התשלום.',
    checkoutError: 'פתיחת התשלום נכשלה. נסו שוב.',
  },
